...
const FLOW = {
  ...
  step_flow_service_ready: {
    type: 'agent',
    showReasoning: true,
    agentMessage: `Here's the flow service — both the business logic and technical view with mapping are ready. Review and let me know if anything needs changing.<br><br>If you're happy with it, I can deploy it on cloud designtime. You can continue to make changes.`,
    showFlowServiceCard: true,
    openWorkspaceOnCreate: true, // auto-open workspace in Business view when card is rendered
    inputType: 'free',
  ...
  step_flow_service_saved: {
    type: 'agent',
    showReasoning: true,
    agentMessage: `I've saved your flow service successfully on cloud designtime. You can continue refining it, and once you're ready, you can run a test to validate the setup.<br><br>If you prefer I can help you with two additional things:<br>1. Update the mapping<br>2. Test with sample data`,
